...
export default function RegisterPricingPlanCard({ card, index, sx, ...other }: Props) {
      ...
      >
        {index === 1 && (
          <Stack sx={{ padding: '8px', backgroundColor: 'primary.main'}}>
            <Label sx={{ color: 'common.white', background:'transparent', fontWeight: '700', fontSize: '14px' }}>
              MOST POPULAR
            </Label>
          </Stack>
        )}
        ...
        >
          ...
          <Button
            ...
            size="large"
            variant="contained"
            sx={{ backgroundColor: 'primary.main', color: "grey.900", fontSize:"16px", fontWeight:"700" }}
