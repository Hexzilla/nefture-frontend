...
export default function AddWalletInformation({ onClick }: Props) {
  ...
  return (
    <>
      ...
      <Button variant="contained" size="large" fullWidth={true} sx={{ marginTop: '1em' }} onClick={onClick}>
        Enter Wallet
      </Button>
      <Typography textAlign={'center'} sx={{ marginTop: '1em' }}>
        Or
      </Typography>
      <Button variant="outlined" size="large" fullWidth={true} sx={{ marginTop: '1em' }} onClick={onClick}>
        Connect Wallet
      </Button>
