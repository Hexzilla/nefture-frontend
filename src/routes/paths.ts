...
export const PATH_AUTH = {
  ...
  pricing: path(ROOTS_AUTH, '/register-pricing'),
  payment: path(ROOTS_AUTH, '/register-payment'),
  welcome: path(ROOTS_AUTH, '/register-welcome'),
...
export const PATH_DASHBOARD = {
  ...
  myProducts: {
    ...
    savedProducts: path(ROOTS_DASHBOARD, 'my-products/saved-products'),
